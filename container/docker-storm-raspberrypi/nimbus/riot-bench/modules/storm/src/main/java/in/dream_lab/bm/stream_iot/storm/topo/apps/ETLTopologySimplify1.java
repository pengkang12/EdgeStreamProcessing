...
public class ETLTopologySimplify1
{
...
//               1);
	   ...
	   builder.setBolt("SenMlParseBolt",
        	...
        	builder.setBolt("RangeFilterBolt", new RangeFilterBolt(p_), bolts_num)
                        .setNumTasks(tasks_num).fieldsGrouping("SenMlParseBolt", new Fields("OBSTYPE")).addConfiguration("tags", "core1");

		 builder.setBolt("BloomFilterBolt",
	                new BloomFilterCheckBolt(p_), bolts_num)
                        .setNumTasks(tasks_num)
	                .fieldsGrouping("RangeFilterBolt", new Fields("OBSTYPE")).addConfiguration("tags", "core1");
		 
		 builder.setBolt("InterpolationBolt",
	                new InterpolationBolt(p_), bolts_num)
                        .setNumTasks(tasks_num)
	                .fieldsGrouping("BloomFilterBolt", new Fields("OBSTYPE")).addConfiguration("tags", "core1");
		 ...
		 builder.setBolt("sink", new Sink(sinkLogFileName), 1)
         			.shuffleGrouping("InterpolationBolt").addConfiguration("tags", "core1");
