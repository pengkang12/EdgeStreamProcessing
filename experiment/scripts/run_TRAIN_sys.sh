...
${home_path}storm/bin/storm jar $app_path in.dream_lab.bm.stream_iot.storm.topo.apps.${app_name} C ${app_name} $input_name PLUG-SYS $scale $output_path ${home_source}tasks.properties test "spout:core"
