...
//			assert Integer.parseInt(rowKeyEnd)<=endRowKey;
			...
			rowKeyStart= "1122756000000";
			rowKeyEnd= "2422756000000";
...
// filters
			...
			TableQuery<Taxi_Trip> rangeQuery =
					TableQuery.from(Taxi_Trip.class).where(partitionFilter);
//							.where(combinedFilter);

			Iterable<Taxi_Trip> queryRes = cloudTable.execute(rangeQuery);
			l.info("QUERY {}", queryRes.toString());
//			// Loop through the results, displaying information about the entity
//			for (Taxi_Trip entity : queryRes) {
//				System.out.println("QUERY "+entity.getPartitionKey() +
//						" " + entity.getRowKey() +
//						"\t" + entity.getFare_amount()
//				);
//			}
